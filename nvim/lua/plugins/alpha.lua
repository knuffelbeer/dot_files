...
[[   '----------'    '----------'   '--------------'`--------------------`                                     .3P"%....                          ]],}         --    button("u", "  > Update plugins", ":PackerSync<CR>"),
		...
		--dashboard.section.buttons.opts.hl = "AlphaButtons"#0ff707
		alpha.setup(dashboard.opts)
vim.api.nvim_set_hl(0, "AlphaHeader", {fg="#870000"})
...
vim.api.nvim_set_hl(0, "AlphaButtons", {fg="#d13223", bg = "#d13223" })
	end,
}
